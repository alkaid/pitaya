...
type KickMsg struct {
	...
	Metadata map[string]string `protobuf:"bytes,3,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` // 用户调用Kick()时的透传数据
}
...
func (x *KickMsg) GetReason() int32 {
	if x != nil {
		return x.Reason
	}
	return 0
...
func (x *KickMsg) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_pitaya_protos_kick_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x22, 0xb1, 0x01, 0x0a, 0x07, 0x4b, 0x69, 0x63, 0x6b, 0x4d, 0x73, 0x67, 0x12, 0x16,
	0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x06, 0x72, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x39,
	0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x1d, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x4b, 0x69, 0x63, 0x6b, 0x4d, 0x73,
	...
	0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x24, 0x0a, 0x0a, 0x4b, 0x69, 0x63, 0x6b, 0x41, 0x6e,
	0x73, 0x77, 0x65, 0x72, 0x12, 0x16, 0x0a, 0x06, 0x6b, 0x69, 0x63, 0x6b, 0x65, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x06, 0x6b, 0x69, 0x63, 0x6b, 0x65, 0x64, 0x42, 0x1b, 0x5a, 0x08,
...
var file_pitaya_protos_kick_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_pitaya_protos_kick_proto_goTypes = []interface{}{
	(*KickMsg)(nil),    // 0: protos.KickMsg
	(*KickAnswer)(nil), // 1: protos.KickAnswer
	nil,                // 2: protos.KickMsg.MetadataEntry
}
var file_pitaya_protos_kick_proto_depIdxs = []int32{
	2, // 0: protos.KickMsg.metadata:type_name -> protos.KickMsg.MetadataEntry
