...
func (m *MockRPCClient) Fork(ctx context.Context, route *route.Route, session session.Session, msg *message.Message) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Fork", ctx, route, session, msg)
	ret0, _ := ret[0].(error)
	return ret0
}

// Fork indicates an expected call of Fork.
func (mr *MockRPCClientMockRecorder) Fork(ctx, route, session, msg interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Fork", reflect.TypeOf((*MockRPCClient)(nil).Fork), ctx, route, session, msg)
}
...
func (m *MockSDListener) ModifyServer(sv, old *cluster.Server) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "ModifyServer", sv, old)
}

// ModifyServer indicates an expected call of ModifyServer.
func (mr *MockSDListenerMockRecorder) ModifyServer(sv, old interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ModifyServer", reflect.TypeOf((*MockSDListener)(nil).ModifyServer), sv, old)
}
...
// MockRemoteSessionListener is a mock of RemoteSessionListener interface.
type MockRemoteSessionListener struct {
	ctrl     *gomock.Controller
	recorder *MockRemoteSessionListenerMockRecorder
}

// MockRemoteSessionListenerMockRecorder is the mock recorder for MockRemoteSessionListener.
type MockRemoteSessionListenerMockRecorder struct {
	mock *MockRemoteSessionListener
}

// NewMockRemoteSessionListener creates a new mock instance.
func NewMockRemoteSessionListener(ctrl *gomock.Controller) *MockRemoteSessionListener {
	mock := &MockRemoteSessionListener{ctrl: ctrl}
	mock.recorder = &MockRemoteSessionListenerMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockRemoteSessionListener) EXPECT() *MockRemoteSessionListenerMockRecorder {
	return m.recorder
}

// OnUserBind mocks base method.
func (m *MockRemoteSessionListener) OnUserBind(uid, fid string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "OnUserBind", uid, fid)
}

// OnUserBind indicates an expected call of OnUserBind.
func (mr *MockRemoteSessionListenerMockRecorder) OnUserBind(uid, fid interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "OnUserBind", reflect.TypeOf((*MockRemoteSessionListener)(nil).OnUserBind), uid, fid)
}
