	...
	for _, table := range tables {
		t.Run(table.name, func(t *testing.T) {
			...
			if table.bindingStorage != nil {
				...
				mockPitayaClient.EXPECT().SessionBindRemote(gomock.Any(), gomock.Any()).Do(func(ctx context.Context, msg *protos.BindMsg, opt ...grpc.CallOption) {
	...
	for _, table := range tables {
		t.Run(table.name, func(t *testing.T) {
			...
			if table.bindingStorage != nil {
				...
				mockPitayaClient.EXPECT().KickUser(gomock.Any(), gomock.Any()).Do(func(ctx context.Context, msg *protos.KickMsg, opt ...grpc.CallOption) {
	...
	for _, table := range tables {
		t.Run(table.name, func(t *testing.T) {
			...
			if table.bindingStorage != nil && table.sv.ID == "" {
				...
				mockPitayaClient.EXPECT().PushToUser(gomock.Any(), gomock.Any()).Do(func(ctx context.Context, msg *protos.Push, opt ...grpc.CallOption) {
